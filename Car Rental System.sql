...
insert into Booking 
values
(101,1,7,"2025-10-01","2025-11-01","kurla","navi mumbai","pending"),
(102,2,8,"2025-07-01","2025-09-12","seawood","Tilaknagar","cancelled"),
(103,3,9,"2024-05-08","2024-06-06","Thane","Vashi","confirmed"),
(104,4,10,"2022-01-06","2022-02-03","Kalyan","Bandra","completed"),
(105,5,11,"2025-01-07","2025-05-07","Dadar","Panvel","pending"),
(106,6,12,"2025-07-09","2025-09-09","sion","Chembur","cancelled");
...
car_id int,foreign key(car_id) REFERENCES Cars(car_id),
 ...
 values
(7,"Oil Change","Regular engine oil change","2025-10-15","scheduled"),
(8,"Tire Rotation","Rotate tires to extend their life","2025-09-10","completed"),
(9,"Brake Inspection","Check brake pads and discs","2025-11-05","scheduled"),
(10,"Battery Replacement","Replace old battery with new one","2025-07-20","cancelled"),
(11,"Engine Tune-up","Complete engine tune-up service","2025-08-30","scheduled");
